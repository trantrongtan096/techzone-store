...
public class SecurityConfig {
    ...
    @Value("${techzone.cors.allowed-origins}")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/payments/orders/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/payments/webhooks/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/dev/payments/**").permitAll()
